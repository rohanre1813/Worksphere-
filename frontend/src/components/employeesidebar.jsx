...
export default function ESidebar() {
  ...
  const menuItems = [
    { label: "Employee Info", icon: User, path: "/employee/dashboard" },
    { label: "Office Area", icon: Map, path: "/employee/office-area" },
    { label: "Announcements", icon: Megaphone, path: "/employee/announcements" },
    { label: "Scan QR", icon: ScanBarcodeIcon, path: "/employee/Scan" },
  ];
  return (
    <>
      ...
      >
        ...
        <div className="p-6 text-center border-b border-yellow-400/30">
          <h1 className="text-yellow-400 font-mono font-bold tracking-widest pl-6">
            EMPLOYEE PANEL
          </h1>
        </div>
